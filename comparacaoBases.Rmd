...
summary(data$Outra.Plataforma.de.Delivery)
summary(data$Instagram.Facebook)
...
summary(data_nome$Instagram.Facebook)
summary(data_nome$Número.de.Seguidores)
summary(data_nome$Avaliação.Google)
summary(data_nome$Avaliação.Ifood)

summary(data_cnpj_nome$Outra.Plataforma.de.Delivery)
summary(data_cnpj_nome$Instagram.Facebook)
...
summary(data_cnpj_nome$Segmento)
